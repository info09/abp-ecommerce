...
import { ProductAttributeDto, ProductAttributeService } from '@proxy/product-attributes';
import { DynamicDialogConfig, DynamicDialogRef } from 'primeng/dynamicdialog';
import { Subject, takeUntil } from 'rxjs';
import { UtilityService } from '../../shared/services/utility.service';
import { NotificationService } from '../../shared/services/notification.service';
import { productAttributeTypeOptions } from '@proxy/ecommerce/attributes';
...
export class AttributeDetailComponent implements OnInit, OnDestroy {
  ...
  loadAttributeTypes() {
    productAttributeTypeOptions.forEach(element => {
      this.dataTypes.push({
        value: element.value,
        label: element.key,
      });
  ...
  private buildForm() {
    this.form = this.fb.group({
      ...
      productAttributeType: new FormControl(
        this.selectedEntity.productAttributeType || null,
        Validators.required
      ),
